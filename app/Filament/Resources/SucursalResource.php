...
class SucursalResource extends Resource
{
    ...
    protected static ?string $recordTitleAttribute = 'nro_sucursal';
                ...
                Forms\Components\Group::make([
                    Forms\Components\Section::make([
                        Forms\Components\TextInput::make('nro_sucursal')
                            ...
                            ->unique()
                            ->required()
                            ->label('Número de Sucursal')->prefix('N°')
                        ->columnSpan(1),
    ...
    {
        return Sucursal::getUrl('view', ['record' => $record]);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewSucursal::route('/{record}/view')
        ];
    }
