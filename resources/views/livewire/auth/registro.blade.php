            ...
            <div class="bg-white rounded-lg shadow-md p-4 md:p-10 mt-5 mb-5"
                ...
                <form method="post" wire:submit.prevent="guardar">
                    ...
                    <div class="text-right mt-2">
                        <p class="mt-4 text-sm text-center">¿Ya tienes una cuenta? <a href="{{ route('login') }}" class="text-sm text-primary font-black hover:text-blue-400 hover:ease-in hover:duration-300">Iniciar sesión</a></p>
                    </div>
